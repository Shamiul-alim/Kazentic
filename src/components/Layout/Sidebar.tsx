...
export default function Sidebar() {
  return (
    <div className=" w-[2.375rem] px-2 py-4  flex flex-grow-0 flex-col items-center bg-[#111953] text-[#FFFFFF] z-10 pb-10">
      {/* Sidebar Buttons */}
      <div className="space-y-3 flex flex-col flex-1 items-center">
        ...
        <div className="flex flex-row justify-center items-center">
          ...
          <button
            className="w-[1.5rem] h-[1.5rem] bg-gradient-to-b from-[#FF9F00] to-[#FDBF00] rounded-md flex justify-center text-center border-transparent"
            style={{
        ...
        {/* Plus Button */}
        <button className="w-[1.5rem] h-[1.5rem] rounded-md flex justify-center  items-center pb-1  mt-4 hover:bg-slate-600 hover:border hover:border-gray-400 hover:bg-opacity-40 ">
        ...
        {/* Section D */}
        <button
          className="w-[1.5rem] h-[1.5rem] bg-gradient-to-b from-[#FF4B00] to-[#FF9F00] rounded-md flex justify-center border-transparent text-center "
          style={{
        ...
        {/* Section L */}
        <button
          className="w-[1.5rem] h-[1.5rem] bg-gradient-to-b from-[#059669] to-[#15BD6D] rounded-md flex justify-center border-transparent text-center"
          style={{
      ...
      <div className="mt-auto mb-4 space-y-3 flex flex-col justify-center items-center">
        {/*Billing*/}
        <button className="w-[1.5rem] h-[1.5rem] rounded-md flex justify-center text-center items-center border border-gray-300 border-opacity-60 bg-[#4157FE] cursor-pointer ">
          <Image
