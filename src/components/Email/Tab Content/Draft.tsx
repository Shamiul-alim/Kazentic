  ...
  return (
    <div className="w-full bg-[#FFFFFF] flex flex-col">
      ...
      <div className="h-[3.25rem] rounded-lg bg-[#FDFDFD] border border-[#EBEBEB] m-[0.6rem] md:ml-[1.25rem] md:mr-[1.25rem] mt-0 flex flex-row items-center justify-between pl-3 pr-3 relative">
        ...
        <div
          className={`w-[11.3rem] h-20 shadow-md bg-[#FFFFFF] rounded-md border border-[#EBEBEB] shadow-[#0000000D] flex-col absolute top-[2.6rem] left-[9rem] z-50 cursor-pointer
        ...
        <div
          className={`
            w-[8.313rem] h-40 bg-[#FFFFFF] shadow-md shadow-[#0000000D] rounded-md
            absolute top-[2.6rem] right-3 z-50
            ${isSortMenuOpen ? "flex flex-col" : "hidden"}
          `}
        >
          <div className="h-10 w-full pl-[1.25rem] bg-[#F2F9FE] border border-[#EBEBEB] justify-start items-center rounded-t-md">
